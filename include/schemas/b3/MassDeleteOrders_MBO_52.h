...
#ifndef _B3_MASSDELETEORDERS_MBO_52_CXX_H_
#define _B3_MASSDELETEORDERS_MBO_52_CXX_H_
...
public:
    ...
    {
        m_transactTime.wrap(m_buffer, m_offset + 16, m_actingVersion, m_bufferLength);
