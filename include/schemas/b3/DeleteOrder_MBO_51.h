...
#ifndef _B3_DELETEORDER_MBO_51_CXX_H_
#define _B3_DELETEORDER_MBO_51_CXX_H_
...
public:
    ...
    {
        m_transactTime.wrap(m_buffer, m_offset + 32, m_actingVersion, m_bufferLength);
...
public:
    ...
    {
        m_mDEntryPx.wrap(m_buffer, m_offset + 44, m_actingVersion, m_bufferLength);
        return m_mDEntryPx;
    }
