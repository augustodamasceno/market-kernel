...
#ifndef _B3_TRADINGSESSIONSUBID_CXX_H_
#define _B3_TRADINGSESSIONSUBID_CXX_H_
...
public:
    enum Value
    {
        ...
        PRE_CLOSE = static_cast<std::uint8_t>(18),
        UNKNOWN_OR_INVALID = static_cast<std::uint8_t>(20),
        PRE_OPEN = static_cast<std::uint8_t>(21),
    ...
    static TradingSessionSubID::Value get(const std::uint8_t value)
    {
        switch (value)
        {
            ...
            case static_cast<std::uint8_t>(18): return PRE_CLOSE;
            case static_cast<std::uint8_t>(20): return UNKNOWN_OR_INVALID;
            case static_cast<std::uint8_t>(21): return PRE_OPEN;
    ...
    static const char *c_str(const TradingSessionSubID::Value value)
    {
        switch (value)
        {
            ...
            case PRE_CLOSE: return "PRE_CLOSE";
