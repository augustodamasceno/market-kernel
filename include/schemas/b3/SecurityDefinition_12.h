...
#ifndef _B3_SECURITYDEFINITION_12_CXX_H_
#define _B3_SECURITYDEFINITION_12_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(232);
    ...
    static constexpr std::uint16_t SBE_SCHEMA_VERSION = static_cast<std::uint16_t>(17);
    static constexpr const char* SBE_SEMANTIC_VERSION = "2.3.1";
    ...
    {
        return static_cast<std::uint16_t>(232);
    }
...
public:
    ...
    SBE_NODISCARD static const char *optPayoutTypeMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t optPayoutTypeId() SBE_NOEXCEPT
    {
        return 1482;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t optPayoutTypeSinceVersion() SBE_NOEXCEPT
    {
        return 16;
    }

    SBE_NODISCARD bool optPayoutTypeInActingVersion() SBE_NOEXCEPT
    {
        return m_actingVersion >= optPayoutTypeSinceVersion();
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t optPayoutTypeEncodingOffset() SBE_NOEXCEPT
    {
        return 231;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t optPayoutTypeEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD std::uint8_t optPayoutTypeRaw() const SBE_NOEXCEPT
    {
        if (m_actingVersion < 16)
        {
            return static_cast<std::uint8_t>(0);
        }
    ...
    SBE_NODISCARD OptPayoutType::Value optPayoutType() const
    {
        if (m_actingVersion < 16)
        {
            return OptPayoutType::NULL_VALUE;
        }

        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 231, sizeof(std::uint8_t));
        return OptPayoutType::get((val));
    }

    SecurityDefinition_12 &optPayoutType(const OptPayoutType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    #pragma GCC diagnostic pop
        ...
        SBE_NODISCARD static SBE_CONSTEXPR char underlyingSecurityExchange(const std::uint64_t index) SBE_NOEXCEPT
        {
            const std::uint8_t underlyingSecurityExchangeValues[] = { 66, 86, 77, 70, 0 };
...
public:
    ...
    #pragma GCC diagnostic pop
        ...
        #if __cplusplus >= 201402L
        SBE_NODISCARD static SBE_CONSTEXPR char legSecurityExchange(const std::uint64_t index) SBE_NOEXCEPT
        {
            const std::uint8_t legSecurityExchangeValues[] = { 66, 86, 77, 70, 0 };
    ...
    std::basic_ostream<CharT, Traits> &builder, const SecurityDefinition_12 &_writer)
{
    ...
    builder << ", ";
    builder << R"("optPayoutType": )";
    builder << '"' << writer.optPayoutType() << '"';
