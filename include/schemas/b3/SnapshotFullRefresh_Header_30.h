...
#ifndef _B3_SNAPSHOTFULLREFRESH_HEADER_30_CXX_H_
#define _B3_SNAPSHOTFULLREFRESH_HEADER_30_CXX_H_
...
public:
    ...
    SBE_NODISCARD static SBE_CONSTEXPR char securityExchange(const std::uint64_t index) SBE_NOEXCEPT
    {
        const std::uint8_t securityExchangeValues[] = { 66, 86, 77, 70, 0 };
    ...
    SBE_NODISCARD static const char *lastSequenceVersionMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t lastSequenceVersionId() SBE_NOEXCEPT
    {
        return 37084;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t lastSequenceVersionSinceVersion() SBE_NOEXCEPT
    {
        return 15;
    }

    SBE_NODISCARD bool lastSequenceVersionInActingVersion() SBE_NOEXCEPT
    {
        return m_actingVersion >= lastSequenceVersionSinceVersion();
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t lastSequenceVersionEncodingOffset() SBE_NOEXCEPT
    {
        return 32;
    }

    static SBE_CONSTEXPR std::uint16_t lastSequenceVersionNullValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(0);
    }

    static SBE_CONSTEXPR std::uint16_t lastSequenceVersionMinValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(0);
    }

    static SBE_CONSTEXPR std::uint16_t lastSequenceVersionMaxValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(65534);
    }

    static SBE_CONSTEXPR std::size_t lastSequenceVersionEncodingLength() SBE_NOEXCEPT
    {
        return 2;
    }

    SBE_NODISCARD std::uint16_t lastSequenceVersion() const SBE_NOEXCEPT
    {
        if (m_actingVersion < 15)
        {
            return static_cast<std::uint16_t>(0);
        }
    ...
    SnapshotFullRefresh_Header_30 &lastSequenceVersion(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
    ...
    std::basic_ostream<CharT, Traits> &builder, const SnapshotFullRefresh_Header_30 &_writer)
{
    ...
    builder << ", ";
    builder << R"("lastSequenceVersion": )";
    builder << +writer.lastSequenceVersion();
