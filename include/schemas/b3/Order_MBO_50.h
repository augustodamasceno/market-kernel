...
#ifndef _B3_ORDER_MBO_50_CXX_H_
#define _B3_ORDER_MBO_50_CXX_H_
...
public:
    ...
    {
        m_transactTime.wrap(m_buffer, m_offset + 56, m_actingVersion, m_bufferLength);
        return m_transactTime;
    }

    SBE_NODISCARD static const char *mDEntryPrevSizeMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t mDEntryPrevSizeId() SBE_NOEXCEPT
    {
        return 37780;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t mDEntryPrevSizeSinceVersion() SBE_NOEXCEPT
    {
        return 16;
    }

    SBE_NODISCARD bool mDEntryPrevSizeInActingVersion() SBE_NOEXCEPT
    {
        return m_actingVersion >= mDEntryPrevSizeSinceVersion();
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t mDEntryPrevSizeEncodingOffset() SBE_NOEXCEPT
    {
        return 64;
    }

    static SBE_CONSTEXPR std::int64_t mDEntryPrevSizeNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t mDEntryPrevSizeMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t mDEntryPrevSizeMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t mDEntryPrevSizeEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t mDEntryPrevSize() const SBE_NOEXCEPT
    {
    ...
    Order_MBO_50 &mDEntryPrevSize(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    std::basic_ostream<CharT, Traits> &builder, const Order_MBO_50 &_writer)
{
    ...
    if (writer.transactTimeInActingVersion())
    {
    ...
    builder << ", ";
    builder << R"("mDEntryPrevSize": )";
    builder << +writer.mDEntryPrevSize();
