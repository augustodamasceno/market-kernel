...
#ifndef _B3_INSTRATTRIBTYPE_CXX_H_
#define _B3_INSTRATTRIBTYPE_CXX_H_
...
public:
    enum Value
    {
        ...
        TEST_INSTRUMENT = static_cast<std::uint8_t>(35),
    ...
    static InstrAttribType::Value get(const std::uint8_t value)
    {
        switch (value)
        {
            ...
            case static_cast<std::uint8_t>(35): return TEST_INSTRUMENT;
    ...
    static const char *c_str(const InstrAttribType::Value value)
    {
        switch (value)
        {
            ...
            case TEST_INSTRUMENT: return "TEST_INSTRUMENT";
